...
#define KEYBOARD_RETURN     0x20
#define KEYBOARD_BACKSPACE  0x80
#define MOUSE_ALL (MOUSE_LEFT | MOUSE_RIGHT | MOUSE_MIDDLE | MOUSE_BACK | MOUSE_FORWARD | KEYBOARD_RETURN | KEYBOARD_BACKSPACE)
